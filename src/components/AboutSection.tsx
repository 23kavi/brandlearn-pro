      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            United Global Scholars is India's emerging leader in institution-integrated extracurricular development for schools and colleges. We build and operate a premium ecosystem of student clubs and leadership programs — so your institution can deliver world-class holistic education without adding a single burden to your team.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-16">
          ...
          >
            ...
            <p className="text-primary-foreground/90 text-lg">
              To develop future-ready global scholars who lead with confidence, innovate with purpose, and create lasting impact — from school through college.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 30 }}
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              To become the gold standard in institution-partnered student development — accessible to every school and college, transformative for every student.
            </p>
          </motion.div>
        </div>
