        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://wa.me/918800129363" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full flex items-center justify-center transition-colors" aria-label="WhatsApp">
